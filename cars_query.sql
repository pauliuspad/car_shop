SELECT cars.number as car_number, cars.year_made as car_year, cars.model as car_model, current_segment.name as current_segment_name , current_user_name.name as current_user_name, statuses.name as current_status, previous_user.name as last_user_name, previous_segment.name as last_segment_name
FROM cars
